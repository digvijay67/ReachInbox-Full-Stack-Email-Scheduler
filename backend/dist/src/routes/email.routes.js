...
// ------------------------------------
router.get("/scheduled", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// ------------------------------------
router.get("/sent", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
        const emails = yield prisma_1.prisma.email.findMany({
            where: {
...
router.get("/sender", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return res.json({
...
router.get("/search", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log("============================");
        const result = yield (0, email_search_service_1.searchEmails)({
            userId: req.user.id,
            query: query || undefined,
            status: typeof req.query.status === "string"
                ? req.query.status.trim()
                : undefined,
            dateFrom: typeof req.query.dateFrom === "string"
                ? req.query.dateFrom.trim()
                : undefined,
            dateTo: typeof req.query.dateTo === "string"
...
router.get("/:id", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const configuredSenderEmail = process.env.SMTP_FROM ||
            process.env.SMTP_USER ||
            ((_a = email.sender) === null || _a === void 0 ? void 0 : _a.email) ||
            "";
        return res.json(Object.assign(Object.assign({}, email), { sender: {
                id: (_c = (_b = email.sender) === null || _b === void 0 ? void 0 : _b.id) !== null && _c !== void 0 ? _c : 0,
...
router.delete("/:id", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (email.jobId) {
            try {
                yield email_queue_1.emailQueue.remove(email.jobId);
            }
            catch (queueError) {
                console.warn(`Failed to remove queue job ${email.jobId}:`, queueError);
            }
        }
        yield (0, email_search_service_1.deleteEmailFromIndex)(email.id);
        yield prisma_1.prisma.email.delete({
            where: {
                id: email.id,
            },
        });
...
router.post("/schedule", auth_1.requireAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        recipients = [
            ...new Set(recipients.filter((item) => item.length > 0)),
        ];
        // ------------------------------------
        ...
        if (recipients.length === 0 ||
            ...
            !scheduledAt) {
            return res.status(400).json({
                message: "to (at least one recipient), subject, body and scheduledAt are required",
            });
        }
        // ------------------------------------
        // 3. Validate every recipient's format
        // ------------------------------------
        const invalidRecipients = recipients.filter((recipientEmail) => !EMAIL_REGEX.test(recipientEmail));
        ...
        for (const recipientEmail of recipients) {
            ...
            // DEBUG
            console.log("BullMQ job created:", job.id, "delay:", delay);
            ...
            yield (0, email_search_service_1.indexEmail)(updatedEmail);
